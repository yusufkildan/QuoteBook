...
class BaseTableViewController : BaseViewController {
    ...
    func finishLoading(withState state: ControllerState, andMessage message: String?) {
        ...
        case .error:
            if statusLabel == nil {
                ...
                statusLabel.font = UIFont.latoMediumFont(withSize: 15.0)
    ...
    override func didReceiveKeyboardWillShowNotification(_ notification: NSNotification) {
        self.handleInsetsOf(ScrollView: tableView, forAction: KeyboardAction.show, withNotification: notification)
    }
    
    override func didReceiveKeyboardWillHideNotification(_ notification: NSNotification) {
        self.handleInsetsOf(ScrollView: tableView, forAction: KeyboardAction.hide, withNotification: notification)
    }
}
